...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	KEYMAP(
		KC_ESC, KC_SLCK, KC_PAUS, KC_F3, KC_F4, KC_MEDIA_PLAY_PAUSE, KC__MUTE, KC__VOLDOWN, KC__VOLUP, KC_SCROLLLOCK, KC_PAUSE, KC_F11, KC_F12, KC_SPC, 
		...
		KC_CAPS, KC_LALT, KC_LGUI, KC_SPC, KC_SPC, MO(2), KC_LEFT, KC_DOWN, KC_RGHT,
		KC__MUTE),
	...
	KEYMAP(
		...
		KC_CAPS, KC_LGUI, KC_LALT, KC_SPC, KC_SPC, MO(2), KC_LEFT, KC_DOWN, KC_RGHT,
		KC__MUTE),

	KEYMAP(
		KC_ESC, RGB_MATRIX_CYCLE_LEFT_RIGHT, RGB_MATRIX_GRADIENT_LEFT_RIGHT, RGB_TOG, RGB_MODE_PLAIN, RGB_MATRIX_BAND_SAT, RGB_MATRIX_BAND_VAL, KC_TRNS, KC_TRNS, RGB_VAD, RGB_VAI, KC_TRNS, KC_TRNS, KC_TRNS, 
